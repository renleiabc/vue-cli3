        ...
        <el-form :model="ruleForm"
            ...
            <div class="views-task-type ">
                <div class="views-task-right views-task-border">
                    <!-- caffe节点配置 -->
                    <div class="views-task-node views-task-bottom views-task-ps views-task-caffe-mg"
                        v-show="caffe_show">
                        <div class="views-task-sitting views-task-select">
                            <div class="views-task-bottom">
                    ...
                    <div class="views-task-tensorflow"
                        v-show="tensorflow_show">
                        <!-- ps节点-->
                        <div class="views-task-node views-task-bottom views-task-ps">
                            <span class="views-task-node-span ">
                                {{$t('views.trainingTask.psNode')}}
                            </span>
                            <div class="views-task-sitting views-task-select">
                                <!-- ps节点 个数-->
                                <div class="views-task-bottom">
                        ...
                        <!-- worker节点-->
                        <div class="views-task-node views-task-bottom views-task-worker">
                            <span class="views-task-node-span ">
                                {{$t('views.trainingTask.workerNode')}}
                            </span>
                            <div class="views-task-sitting views-task-select">
                                <!-- worker节点 个数-->
                                <div class="views-task-bottom">
