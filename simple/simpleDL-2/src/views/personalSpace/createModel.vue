...
<template>
    <div class="views-personal">
        ...
        <el-dialog :title="modelDialog.title" :visible.sync="modelDialog.dialogCode" :before-close="handleClose" class="small">
            <div class="content">
                <views-code-directory :isFirst="modelDialog.isFirst" :isSecond="modelDialog.isSecond" :type='modelDialog.type'></views-code-directory>
            </div>
...
export default {
  ...
  methods: {
    ...
    modelpredictioncreate (obj) {
      this.$post('/personal/modelpredictioncreate', { ModelPrediction: obj }).then(res => {
