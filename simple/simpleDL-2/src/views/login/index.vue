 ...
 * @LastEditTime: 2018-08-22 13:44:49
 * @Description:
 */
/*
* @LastEditors: aFei
  ...
  methods: {
    ...
    setPermissionList (res) {
      ...
      if (res.code === 200) { // 登陆成功
        ...
        let permissionList = []
        const publicPermissionList = ['8', '8-1', '8-4', '8-5', '8-6', '8-7', '9', '9-1', '9-4', '10', '10-1', '10-2', '11', '11-1', '12', '12-2', '12-3', '12-4', '12-5', '13', '13-1', '14']
            ...
            .filter(function (item) {
              return (
                item.meta.show !== false &&
                                        permissionList.indexOf(`,${permissionTemplate[item.name]},`) !==
                                        -1
              )
            })
            .map(function (item) {
