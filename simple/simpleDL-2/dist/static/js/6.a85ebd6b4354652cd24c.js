...
// load the styles
var content = __webpack_require__("TXTv");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("71d4df8c", content, true, {});
...
/* harmony default export */ var projectManagement = ({
  ...
  methods: {
    ...
    saveAuthenticate: function saveAuthenticate(row) {
      ...
      link.href = "//192.168.10.95:86" + '/v1/storage/downloadkey?access-token=' + JSON.parse(localStorage.getItem('userinfo')).access_token + '&storage_id=' + row.id;
...
/* scopeId */
var __vue_scopeId__ = "data-v-25d5be0a"
