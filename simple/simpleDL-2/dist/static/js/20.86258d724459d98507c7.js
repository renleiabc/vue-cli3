...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/views/storageManagement/personalManagement.vue
...
/* harmony default export */ var personalManagement = ({
  name: 'announcement',
  data: function data() {
    return {
  ...
  methods: {
    ...
    // 保存认证
    saveAuthenticate: function saveAuthenticate() {
      var link = document.createElement('a');
      link.href = "//192.168.10.95:86" + '/v1/storage/downloadkey?access-token=' + JSON.parse(localStorage.getItem('userinfo')).access_token;
...
var Component = normalizeComponent(
  personalManagement,
  storageManagement_personalManagement,
...
/* harmony default export */ var views_storageManagement_personalManagement = __webpack_exports__["default"] = (Component.exports);
