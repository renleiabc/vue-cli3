...
export default {
  ...
  created () {
    ...
    this.nodeObj.id = this.resource.practice_id = this.logParams.practice_id = this.obj.practice_id = this.index = this.$route.query.partTaskId
  ...
  methods: {
    ...
    getPracticelog (obj) {
      let that = this
      this.obj.practice_id = this.$route.query.partTaskId
