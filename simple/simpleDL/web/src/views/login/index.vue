 ...
 * @LastEditors: renlei
 * @LastEditTime: 2019-08-28 11:57:33
 * @Description:登录
 -->
  ...
  methods: {
    handleInit (role) {
      ...
      setTimeout(function () {
        ...
        let params = {
          username: role,
          password: window.btoa('qwe123')
        }
        that.$post('/user/signin', params).then(res => {
          console.log(res)
          that.setPermissionList(res)
        })
        // if (that.login_bool1 && that.login_bool2) {
        //   // if (!free) {
        //   //   this.toggleLoading()
        //   // }
        //   let params = {
    ...
    setPermissionList (res) {
      ...
      if (res.code === 200) { // 登陆成功
        ...
        let permissionList = []
        const publicPermissionList = ['8', '8-1', '8-4', '8-5', '8-6', '8-7']
        if (res.data.role === 2) { // admin
          permissionList = ['8', '8-1', '8-4', '8-5', '8-6', '8-7', '9', '9-1', '9-5', '9-6', '9-7', '10', '10-1', '10-2', '11', '11-1', '12', '12-2', '12-3', '12-4', '12-5', '13', '13-1', '14', '15', '15-1', '1', '1-1', '2', '2-1', '2-2', '2-3', '3', '3-1', '3-2', '3-3', '4', '4-1', '4-1-1', '4-1-1-1', '4-2', '4-2-1', '9-4', '10-3', '12-1', '14-1'] // 权限列表
          userCharacter = 'admin'
        } else if (res.data.role === 3) { // projectManager
          permissionList = ['5', '5-1', '6', '6-1', '6-1-1', '6-1-2', '6-1-2-1', '6-1-2-2', '6-1-2-3', '6-1-3', '6-1-4', '6-1-5', '6-2', '6-3', '6-2-1', '6-2-1-1', '6-2-1-2', '6-2-1-3', '6-2-2', '6-2-3', '6-2-4', '7', '7-1', '7-1-1', '7-1-2', '7-2', '7-2-1', '7-2-2', '7-3', '7-3-1', '7-3-2', '8-2', '8-3', '9-2', '9-3', '14-2'] // 权限列表
