/*
 * @Author: aFei
 * @Date: 2018-08-1 10:18:40
 * @LastEditors: 少侠
 * @LastEditTime: 2018-10-18 10:33:34
 * @Description:
 */
/*
* @LastEditors: aFei
* @LastEditTime: 2018-08-22 15:16:45
*/
<template>
  <div class='login-page'
    ...
    <transition name='form-fade'
      ...
      <div class='manage-tip animated'
        ...
        <div class="logo-title" style="height:40px;">
          <!-- <img class="logo"
               :src="mixinGetImage(
             'views/global/',
             'logo.png')" />
  ...
  methods: {
    ...
    setPermissionList (res) {
      ...
      if (res.code === 200) { // 登陆成功
        ...
        let permissionList = []
        const publicPermissionList = ['8', '8-1', '8-4', '8-5', '8-6', '8-7', '9', '9-1', '9-5', '9-6', '9-7', '10', '10-1', '10-2', '11', '11-1', '12-2', '12-3', '12-4', '12-5', '13', '13-1', '14', '15', '15-1']
        if (res.data.role === 2) { // admin
          permissionList = ['1', '1-1', '2', '2-1', '2-2', '2-3', '3', '3-1', '3-2', '3-3', '4', '4-1', '4-1-1', '4-1-1-1', '4-2', '4-2-1', '9-4', '10-3', '12-1', '14-1'] // 权限列表
          userCharacter = 'admin'
