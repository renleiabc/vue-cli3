...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/views/projectSpace/developDetails.vue
  ...
  methods: {
    ...
    environmentresource: function environmentresource(obj) {
      ...
      this.$post('/environmentproject/environmentresource', obj).then(function (res) {
        ...
        if (res.code === 200) {
          var data = res.data;
          data.show.value = Object(util["g" /* toPercent */])(data.show.value);
          data.cpu.value = Object(util["g" /* toPercent */])(data.cpu.value);
          data.memory.value = Object(util["g" /* toPercent */])(data.memory.value);
          data.gpu.value = Object(util["g" /* toPercent */])(data.gpu.value);
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-63640c5e","hasScoped":false,"transformToRequire":{"video":["src","poster"],"source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/views/projectSpace/developDetails.vue
...
/* harmony default export */ var projectSpace_developDetails = (esExports);
// CONCATENATED MODULE: ./src/views/projectSpace/developDetails.vue
...
/* harmony default export */ var views_projectSpace_developDetails = __webpack_exports__["default"] = (Component.exports);
