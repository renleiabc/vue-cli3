...
/* harmony default export */ var newImage = ({
  ...
  data: function data() {
    ...
    return {
      ...
      hasObjectData: false,
      para: {
        target: "//192.168.10.95:85" + '/v1/image/imageupload', // 后台上传地址
