...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-739f9bdd","hasScoped":false,"transformToRequire":{"video":["src","poster"],"source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/views/storageManagement/fileManagement.vue
...
/* harmony default export */ var storageDetail = ({
  ...
  methods: {
    ...
    saveStorageName: function saveStorageName() {
      ...
      if (!Object(validate["b" /* valiName */])(this.updateSpaceName.trim())) {
        this.$message({ message: "存储空间名称不能包含<>:\\'\"/.", type: 'error' });
        return false;
      }
      parms.is_init = this.is_init;
      parms.name = this.updateSpaceName;
      this.$post('/storage/storagecreate', { id: this.baseinfo.id, Storage: parms }).then(function (res) {
        console.log(res);
        if (res.code === 200) {
          _this.dialogSpaceName = false;
          _this.$message({ message: _this.$t('views.notification.saved'), type: 'success' });
          _this.baseinfo.name = _this.updateSpaceName;
        }
      });
    },
    ...
    saveStorageDesc: function saveStorageDesc() {
      ...
      if (!this.boolSpaceDesc) {
        ...
        this.$post('/storage/storagecreate', { id: this.baseinfo.id, Storage: parms }).then(function (res) {
          console.log(res);
          if (res.code === 200) {
            _this2.$message({ message: _this2.$t('views.notification.saved'), type: 'success' });
            _this2.baseinfo.describe = _this2.updateSpaceDesc;
            _this2.dialogSpaceDesc = false;
          }
        });
      }
    ...
    getStorageDetail: function getStorageDetail() {
      ...
      this.$get('/storage/storagedetails', { storage_id: this.baseinfo.id }).then(function (res) {
        _this3.baseinfo = extends_default()({}, res.data);
      });
    }
  },
  created: function created() {
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-4eea39da","hasScoped":false,"transformToRequire":{"video":["src","poster"],"source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/views/storageManagement/storageDetail.vue
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"storage-detail"},[_c('div',{staticStyle:{"padding":"10px 0"}},[_vm._m(0),_vm._v(" "),_c('div',{staticClass:"clear-float",staticStyle:{"padding":"10px 0"}},[_c('div',{staticClass:"base-info-v"},[_c('div',[_c('span',[_vm._v("空间名称：")]),_vm._v(" "),_c('p',{staticClass:"text-ellipsis",attrs:{"title":_vm.baseinfo.name}},[_vm._v(_vm._s(_vm.baseinfo.name))]),_vm._v(" "),_c('i',{staticClass:"iconfont icon-edit edit-btn primary-color",on:{"click":_vm.btnEditesStorageName}})]),_vm._v(" "),_c('div',[_c('span',[_vm._v("创建时间：")]),_vm._v(" "),_c('p',[_vm._v(_vm._s(_vm.baseinfo.created_at))])]),_vm._v(" "),_c('div',[_c('span',[_vm._v("对象数量：")]),_vm._v(" "),_c('p',[_c('span',[_vm._v(_vm._s(_vm.baseinfo.objectcount))]),_vm._v("个")])]),_vm._v(" "),_c('div',[_c('span',[_vm._v("存储用量：")]),_vm._v(" "),_c('p',[_vm._v(_vm._s(_vm.numberFormatter(_vm.baseinfo.sizebytes)))])]),_vm._v(" "),_c('div',[_c('span',[_vm._v("拥有者：")]),_vm._v(" "),_c('p',[_vm._v(_vm._s(_vm.baseinfo.user))]),_vm._v(" "),_c('a',{on:{"click":_vm.showSpaceDesc}},[_vm._v("查看空间描述")])])])])]),_vm._v(" "),_c('fileManage'),_vm._v(" "),_c('el-dialog',{staticClass:"small",attrs:{"title":"修改空间名称","visible":_vm.dialogSpaceName},on:{"update:visible":function($event){_vm.dialogSpaceName=$event}}},[_c('div',{staticClass:"input-label"},[_c('span',{staticStyle:{"width":"80px"}},[_vm._v("空间名称")]),_vm._v(" "),_c('el-input',{attrs:{"maxlength":"30","size":"medium"},model:{value:(_vm.updateSpaceName),callback:function ($$v) {_vm.updateSpaceName=$$v},expression:"updateSpaceName"}})],1),_vm._v(" "),_c('div',{staticClass:"dialog-footer",attrs:{"slot":"footer"},slot:"footer"},[_c('el-button',{on:{"click":function($event){_vm.dialogSpaceName = false}}},[_vm._v("取消")]),_vm._v(" "),_c('el-button',{staticClass:"primary",attrs:{"type":"primary"},on:{"click":_vm.saveStorageName}},[_vm._v("确定")])],1)]),_vm._v(" "),_c('el-dialog',{staticClass:"small",attrs:{"title":"空间描述","before-close":_vm.closeSpaceDesc,"visible":_vm.dialogSpaceDesc},on:{"update:visible":function($event){_vm.dialogSpaceDesc=$event}}},[_c('div',{staticClass:"input-label"},[(_vm.boolSpaceDesc)?_c('div',[_c('p',{staticStyle:{"line-height":"150%"}},[_vm._v(_vm._s(this.updateSpaceDesc))])]):_c('el-input',{attrs:{"maxlength":"200","rows":"6","type":"textarea"},model:{value:(_vm.updateSpaceDesc),callback:function ($$v) {_vm.updateSpaceDesc=$$v},expression:"updateSpaceDesc"}})],1),_vm._v(" "),_c('div',{staticClass:"dialog-footer",attrs:{"slot":"footer"},slot:"footer"},[(_vm.boolSpaceDesc)?_c('el-button',{staticClass:"primary",attrs:{"type":"primary"},on:{"click":_vm.saveStorageDesc}},[_vm._v("编辑")]):_c('el-button',{staticClass:"primary",attrs:{"type":"primary"},on:{"click":_vm.saveStorageDesc}},[_vm._v("保存")])],1)])],1)}
