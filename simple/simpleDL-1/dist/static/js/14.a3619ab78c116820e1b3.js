  ...
  methods: {
    ...
    submitForm: function submitForm(formName) {
      ...
      this.$refs[formName].validate(function (valid) {
        if (valid) {
          if (_this3.isCreatUser) {
            _this3.$post('/user/adduser', parms).then(function (res) {
              if (res.code === 200) {
                _this3.$message({
            ...
            var parm = {};
            parm.id = _this3.$route.query.userId;
            parm['name'] = _this3.ruleForm.name.trim();
            // 是否初始化密码
            if (_this3.checkedInit) {
              _this3.ruleForm.isInitPwd = 1;
              _this3.initializePassword(parm.id);
            } else {
              _this3.ruleForm.isInitPwd = 0;
              parm['password'] = _this3.ruleForm.password;
            }
            parm['isInitPwd'] = _this3.ruleForm.isInitPwd;
            parm['email'] = _this3.ruleForm.email;
            parm['phone'] = _this3.ruleForm.tel;
            parm['weixin'] = _this3.ruleForm.weixin;
            parm['classes_id'] = _this3.ruleForm.classes;
            parm['gender'] = _this3.ruleForm.gender;
            parm['grade'] = _this3.ruleForm.grade;
            parm['status'] = _this3.ruleForm.status ? 1 : 0;
            parm['department'] = _this3.ruleForm.department;
            parm['introduce'] = _this3.ruleForm.userinfo;
            _this3.$post('/user/edituser', parm).then(function (res) {
              console.log(res);
              if (res.code === 200) {
                _this3.$message({
                  message: _this3.$t('views.notification.saved'),
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-349a047d","hasScoped":false,"transformToRequire":{"video":["src","poster"],"source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/views/userManagement/addUser.vue
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"views-user-management-add-user"},[_c('el-form',{ref:"ruleForm",attrs:{"model":_vm.ruleForm,"rules":_vm.rules,"label-width":_vm.labelWidth}},[_c('el-row',[_c('el-col',{attrs:{"span":10}},[_c('el-form-item',{attrs:{"label":_vm.$t("views.userManagement.username"),"prop":"username"}},[_c('el-input',{attrs:{"maxlength":"16","disabled":_vm.isEnUsername},model:{value:(_vm.ruleForm.username),callback:function ($$v) {_vm.$set(_vm.ruleForm, "username", $$v)},expression:"ruleForm.username"}})],1)],1),_vm._v(" "),_c('el-col',{attrs:{"span":10,"push":2}},[_c('el-form-item',{attrs:{"label":_vm.$t("views.userManagement.name"),"prop":"name"}},[_c('el-input',{attrs:{"maxlength":"16"},model:{value:(_vm.ruleForm.name),callback:function ($$v) {_vm.$set(_vm.ruleForm, "name", $$v)},expression:"ruleForm.name"}})],1)],1),_vm._v(" "),_c('el-col',{attrs:{"span":4}})],1),_vm._v(" "),_c('el-row',[_c('el-col',{attrs:{"span":10}},[_c('el-form-item',{attrs:{"label":_vm.$t("views.userManagement.status"),"prop":"status"}},[_c('el-switch',{attrs:{"active-text":_vm.$t("views.userManagement.open"),"inactive-text":_vm.$t("views.userManagement.close")},model:{value:(_vm.ruleForm.status),callback:function ($$v) {_vm.$set(_vm.ruleForm, "status", $$v)},expression:"ruleForm.status"}})],1)],1),_vm._v(" "),_c('el-col',{attrs:{"span":10,"push":2}},[_c('el-form-item',{attrs:{"label":_vm.$t("views.userManagement.gender"),"prop":"gender"}},[_c('el-radio-group',{model:{value:(_vm.ruleForm.gender),callback:function ($$v) {_vm.$set(_vm.ruleForm, "gender", $$v)},expression:"ruleForm.gender"}},[_c('el-radio',{attrs:{"label":1}},[_vm._v(_vm._s(_vm.$t("views.userManagement.man")))]),_vm._v(" "),_c('el-radio',{attrs:{"label":2}},[_vm._v(_vm._s(_vm.$t("views.userManagement.woman")))])],1)],1)],1),_vm._v(" "),_c('el-col',{attrs:{"span":4}})],1),_vm._v(" "),_c('el-row',[(!this.$route.query.userId)?_c('el-col',{attrs:{"span":10}},[_c('el-form-item',{attrs:{"label":_vm.$t("views.userManagement.character"),"prop":"role"}},[_c('el-select',{attrs:{"placeholder":_vm.$t("views.userManagement.addUser.selRole")},model:{value:(_vm.ruleForm.role),callback:function ($$v) {_vm.$set(_vm.ruleForm, "role", $$v)},expression:"ruleForm.role"}},[_c('el-option',{attrs:{"label":_vm.$t("views.userManagement.addUser.admin"),"value":2}}),_vm._v(" "),_c('el-option',{attrs:{"label":_vm.$t("views.userManagement.addUser.participant"),"value":3}}),_vm._v(" "),_c('el-option',{attrs:{"label":_vm.$t("views.userManagement.addUser.manager"),"value":4}})],1)],1)],1):_vm._e()],1),_vm._v(" "),_c('el-row',[_c('el-col',{attrs:{"span":10}},[_c('el-form-item',{attrs:{"label":_vm.$t("views.userManagement.department"),"prop":"department"}},[_c('el-input',{attrs:{"maxlength":"20"},model:{value:(_vm.ruleForm.department),callback:function ($$v) {_vm.$set(_vm.ruleForm, "department", $$v)},expression:"ruleForm.department"}})],1)],1),_vm._v(" "),_c('el-col',{attrs:{"span":10,"push":2}},[_c('el-form-item',{attrs:{"label":_vm.$t("views.userManagement.grade"),"prop":"grade"}},[_c('el-input',{attrs:{"maxlength":"20"},model:{value:(_vm.ruleForm.grade),callback:function ($$v) {_vm.$set(_vm.ruleForm, "grade", $$v)},expression:"ruleForm.grade"}})],1)],1),_vm._v(" "),_c('el-col',{attrs:{"span":4}})],1),_vm._v(" "),_c('el-row',[_c('el-col',{attrs:{"span":10}},[_c('el-form-item',{attrs:{"label":_vm.$t("views.userManagement.class"),"prop":"classes"}},[_c('el-input',{attrs:{"maxlength":"20"},model:{value:(_vm.ruleForm.classes),callback:function ($$v) {_vm.$set(_vm.ruleForm, "classes", $$v)},expression:"ruleForm.classes"}})],1)],1),_vm._v(" "),_c('el-col',{attrs:{"span":10,"push":2}},[_c('el-form-item',{attrs:{"label":_vm.$t("views.userManagement.phone"),"prop":"tel"}},[_c('el-input',{attrs:{"maxlength":"11"},model:{value:(_vm.ruleForm.tel),callback:function ($$v) {_vm.$set(_vm.ruleForm, "tel", $$v)},expression:"ruleForm.tel"}})],1)],1),_vm._v(" "),_c('el-col',{attrs:{"span":4}})],1),_vm._v(" "),_c('el-row',[_c('el-col',{attrs:{"span":10}},[_c('el-form-item',{attrs:{"label":_vm.$t("views.userManagement.email"),"prop":"email"}},[_c('el-input',{attrs:{"maxlength":"50"},model:{value:(_vm.ruleForm.email),callback:function ($$v) {_vm.$set(_vm.ruleForm, "email", $$v)},expression:"ruleForm.email"}})],1)],1),_vm._v(" "),_c('el-col',{attrs:{"span":10,"push":2}},[_c('el-form-item',{attrs:{"label":_vm.$t("views.userManagement.weChatNumber"),"prop":"weixin"}},[_c('el-input',{attrs:{"maxlength":"30"},model:{value:(_vm.ruleForm.weixin),callback:function ($$v) {_vm.$set(_vm.ruleForm, "weixin", $$v)},expression:"ruleForm.weixin"}})],1)],1),_vm._v(" "),_c('el-col',{attrs:{"span":4}})],1),_vm._v(" "),_c('el-row',[_c('el-col',{attrs:{"span":22}},[_c('el-form-item',{attrs:{"label":_vm.$t("views.userManagement.personalProfile"),"prop":"userinfo"}},[_c('el-input',{attrs:{"type":"textarea","rows":4,"maxlength":"100"},model:{value:(_vm.ruleForm.userinfo),callback:function ($$v) {_vm.$set(_vm.ruleForm, "userinfo", $$v)},expression:"ruleForm.userinfo"}})],1)],1)],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":_vm.$t("views.userManagement.updatePassword"),"prop":"type"}},[(!_vm.isCreatUser)?_c('el-checkbox',{on:{"change":_vm.pwdRest},model:{value:(_vm.checkedRest),callback:function ($$v) {_vm.checkedRest=$$v},expression:"checkedRest"}},[_vm._v(_vm._s(_vm.$t("views.userManagement.resetPassword")))]):_vm._e(),_vm._v(" "),_c('el-checkbox',{on:{"change":_vm.pwdInit},model:{value:(_vm.checkedInit),callback:function ($$v) {_vm.checkedInit=$$v},expression:"checkedInit"}},[_vm._v(_vm._s(_vm.$t("views.userManagement.initPassword")))])],1),_vm._v(" "),_c('el-row',[_c('el-col',{attrs:{"span":10}},[_c('el-form-item',{attrs:{"label":"","type":"password","prop":"password"}},[_c('el-input',{attrs:{"type":"password","disabled":_vm.passwordEnable},model:{value:(_vm.ruleForm.password),callback:function ($$v) {_vm.$set(_vm.ruleForm, "password", $$v)},expression:"ruleForm.password"}})],1)],1)],1),_vm._v(" "),_c('el-row',[_c('el-col',{attrs:{"span":10}},[_c('el-form-item',{attrs:{"label":"","type":"password","prop":"validPassword"}},[_c('el-input',{attrs:{"type":"password","disabled":_vm.passwordEnable},model:{value:(_vm.ruleForm.validPassword),callback:function ($$v) {_vm.$set(_vm.ruleForm, "validPassword", $$v)},expression:"ruleForm.validPassword"}})],1)],1)],1),_vm._v(" "),_c('el-form-item',{staticClass:"text-center"},[_c('el-button',{on:{"click":_vm.mixinGoBack}},[_vm._v(_vm._s(_vm.$t("views.button.back")))]),_vm._v(" "),_c('el-button',{staticClass:"btn light",on:{"click":function($event){_vm.resetForm('ruleForm')}}},[_vm._v(_vm._s(_vm.$t("views.button.reset")))]),_vm._v(" "),_c('el-button',{staticClass:"btn dark",attrs:{"type":"primary"},on:{"click":function($event){_vm.submitForm('ruleForm')}}},[_vm._v(_vm._s(_vm.$t("views.button.save")))])],1)],1)],1)}
var staticRenderFns = []
