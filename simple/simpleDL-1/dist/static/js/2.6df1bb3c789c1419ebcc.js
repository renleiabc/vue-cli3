...
/* harmony default export */ var partCreatDevelop = ({
  ...
  created: function created() {
    this.projectId = this.obj.project_id = this.$route.query.partId;
    // 项目配额限制函数调用
