...
/* harmony default export */ var personalManagement = ({
  ...
  methods: {
    ...
    saveAuthenticate: function saveAuthenticate() {
      ...
      link.href = "//192.168.10.95:85" + '/v1/storage/downloadkey?access-token=' + JSON.parse(localStorage.getItem('userinfo')).access_token;
