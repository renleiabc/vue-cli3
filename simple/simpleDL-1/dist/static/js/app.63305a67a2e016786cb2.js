...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-d12edb6a","hasScoped":true,"transformToRequire":{"video":["src","poster"],"source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./node_modules/vue-ele-nav/src/lib/eleNav.vue
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('el-menu',{ref:"tab",staticClass:"extra",class:_vm.cname,style:(_vm.myStyle),attrs:{"unique-opened":_vm.accordion===true? true:false,"collapse":true,"default-openeds":_vm.horizontal===true? [] : _vm.opens,"mode":_vm.horizontal===true? 'horizontal':'vertical'},on:{"select":_vm.saveOpen}},_vm._l((_vm.navInformation),function(item){return (item.children!==undefined && item.children.length>0)?_c('el-submenu',{key:item.index,attrs:{"index":item.index}},[_c('template',{slot:"title"},[_c('i',{staticClass:"icon iconfont",class:item.iconName}),_vm._v("\n      "+_vm._s(_vm.i18n===true?_vm.$t(item.name):item.name)+"\n    ")]),_vm._v(" "),_c('el-menu-item-group',_vm._l((item.children),function(one){return _c('el-menu-item',{key:one.index,attrs:{"index":one.index}},[_c('router-link',{class:one.active===true?'replace_active_child':'',attrs:{"to":{name:one.linkName}}},[_c('i',{staticClass:"icon iconfont",class:one.iconName}),_vm._v("\n          "+_vm._s(_vm.i18n===true?_vm.$t(one.name):one.name)+"\n        ")])],1)}))],2):_c('el-menu-item-group',{key:item.index,staticClass:"else",attrs:{"index":item.index}},[_c('el-menu-item',{attrs:{"index":item.index}},[_c('router-link',{class:item.active===true?'replace_active':'',attrs:{"to":{name:item.linkName}}},[_c('i',{staticClass:"icon iconfont",class:item.iconName}),_vm._v("\n        "+_vm._s(_vm.i18n===true?_vm.$t(item.name):item.name)+"\n      ")])],1)],1)}))}
var staticRenderFns = []
...
function injectStyle (ssrContext) {
  __webpack_require__("uR4p")
  __webpack_require__("x7gq")
  __webpack_require__("xFlk")
}
...
/* scopeId */
var __vue_scopeId__ = "data-v-d12edb6a"
...
module.exports = __webpack_require__.p + "static/img/陪标一首页.dcc35a6.png";
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-2294ea41","hasScoped":false,"transformToRequire":{"video":["src","poster"],"source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/views/main/main.vue
var main_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('el-container',[_c('el-header',{staticClass:"views-main-el-header"},[_c('div',{staticStyle:{"margin-right":"10px","float":"right"}},[_c('div',{staticStyle:{"margin-top":"-6px"}},[(this.$store.getters.checkUserCharacter==='admin')?_c('span',[_vm._v(_vm._s(_vm.$t('views.userMenu.admin')))]):_vm._e(),_vm._v(" "),(this.$store.getters.checkUserCharacter==='projectManager')?_c('span',[_vm._v(_vm._s(_vm.$t('views.userMenu.projectManager')))]):_vm._e(),_vm._v(" "),(this.$store.getters.checkUserCharacter==='projectParticipant')?_c('span',[_vm._v(_vm._s(_vm.$t('views.userMenu.projectParticipant')))]):_vm._e()]),_vm._v(" "),_c('div',{staticStyle:{"float":"right","margin-top":"-14px"}},[_c('el-button',{attrs:{"size":"mini","icon":"iconfont icon-tuichu","circle":""},on:{"click":_vm.loginOut}})],1)])]),_vm._v(" "),_c('el-container',[_c('el-scrollbar',{staticClass:"views-main-el-aside-navbar"},[_c('ele-nav',{attrs:{"cname":"navbar","id":"nav-div","navInformation":_vm.navInformation}})],1),_vm._v(" "),_c('el-scrollbar',{staticClass:"views-main-container"},[_c('el-main',[_c('p',{staticClass:"views-main-navigate"},[_vm._v("\n          "+_vm._s(_vm.$t('views.navigate.title'))+"：\n          "),_vm._l((_vm.navigate),function(item,index){return (index<_vm.navigate.length-1)?_c('span',{key:index},[_c('router-link',{attrs:{"to":{name:item.linkName}}},[_vm._v(_vm._s(_vm.$t(item.name))+"  >")])],1):_c('span',[_vm._v(_vm._s(_vm.$t(item.name)))])}),_vm._v(" "),(_vm.showNav)?_c('button',{staticClass:"views-main-goBack",on:{"click":_vm.mixinGoBack}},[_vm._v("\n            "+_vm._s(_vm.$t('views.navigate.back'))+"\n          ")]):_vm._e()],2),_vm._v(" "),_c('keep-alive',[(_vm.$route.meta.keepAlive===true)?_c('router-view',{on:{"showNavigate":_vm.changeNavigate}}):_vm._e()],1),_vm._v(" "),(_vm.$route.meta.keepAlive!==true)?_c('router-view',{on:{"showNavigate":_vm.changeNavigate}}):_vm._e()],1)],1)],1)],1)}
...
/* harmony default export */ var systemMonitoring = ({
  ...
  component: function component(page) {
    return __webpack_require__.e/* require */(16).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("/zHP")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
  },
  meta: {
  ...
  children: [{
    ...
    path: '/',
    component: function component(page) {
      return __webpack_require__.e/* require */(15).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("QZKG")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    },
    meta: {
      title: 'views.nav.systemMonitoring',
...
/* harmony default export */ var systemManagement = ({
  ...
  component: function component(page) {
    return __webpack_require__.e/* require */(20).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("wuZG")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
  },
  ...
  children: [{
    ...
    path: 'systemAlarm',
    component: function component(page) {
      return __webpack_require__.e/* require */(19).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("683F")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    },
    meta: {
    ...
    path: 'systemLog',
    component: function component(page) {
      return __webpack_require__.e/* require */(18).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("6hsl")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    },
    meta: {
    ...
    path: 'systemSetting',
    component: function component(page) {
      return __webpack_require__.e/* require */(17).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("QCcE")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    },
    meta: {
...
/* harmony default export */ var userManagement = ({
  ...
  component: function component(page) {
    return __webpack_require__.e/* require */(13).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("Cxe8")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
  },
  meta: {
  ...
  children: [{
    ...
    path: '',
    component: function component(page) {
      return __webpack_require__.e/* require */(11).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("WvI5")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    },
    meta: {
      title: 'views.nav.userManagement',
    ...
    path: 'userDetails',
    component: function component(page) {
      return __webpack_require__.e/* require */(12).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("FYWr")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    },
    meta: {
    ...
    path: 'editUser',
    component: function component(page) {
      return Promise.all/* require */([__webpack_require__.e(0), __webpack_require__.e(14)]).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("BrQ/")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    },
    meta: {
...
/* harmony default export */ var clusterMonitoring = ({
  ...
  component: function component(page) {
    return __webpack_require__.e/* require */(56).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("UOKF")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
  },
  ...
  children: [{
    ...
    path: 'nodeControl',
    component: function component(page) {
      return __webpack_require__.e/* require */(53).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("sBR9")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    },
    meta: {
    ...
    component: function component(page) {
      return __webpack_require__.e/* require */(52).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("rg0j")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    },
    meta: {
    ...
    component: function component(page) {
      return __webpack_require__.e/* require */(57).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("Xuru")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    },
    meta: {
    ...
    path: 'namespaces',
    component: function component(page) {
      return __webpack_require__.e/* require */(55).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("DsS7")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    },
    meta: {
    ...
    component: function component(page) {
      return __webpack_require__.e/* require */(54).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("V203")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    },
    meta: {
...
/* harmony default export */ var home = ({
  ...
  component: function component(page) {
    return __webpack_require__.e/* require */(51).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("KR8f")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
  },
  meta: {
    title: 'views.nav.home',
    icon: 'icon-shouye1 homeColor'
  },
  children: [{
    name: 'projectHome',
    path: '/',
    component: function component(page) {
      return __webpack_require__.e/* require */(50).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("MUvH")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    },
    meta: {
      show: false,
      replaceIndex: true,
...
/* harmony default export */ var projectSpace = ({
  ...
  path: 'projectSpace',
  component: function component(page) {
    return __webpack_require__.e/* require */(41).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("B6Sh")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
  },
  redirect: {
    name: 'spaceContent'
  },
  ...
  children: [{
    ...
    path: 'spaceContent',
    component: function component(page) {
      return Promise.all/* require */([__webpack_require__.e(0), __webpack_require__.e(33)]).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("mMuX")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    },
    meta: {
    ...
    path: 'projectSetting',
    component: function component(page) {
      return Promise.all/* require */([__webpack_require__.e(0), __webpack_require__.e(8)]).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("mDZD")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    },
    meta: {
    ...
    path: 'projectDetails',
    component: function component(page) {
      return __webpack_require__.e/* require */(32).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("e9LZ")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    },
    meta: {
    ...
    component: function component(page) {
      return __webpack_require__.e/* require */(42).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("q7jr")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    },
    meta: {
    ...
    component: function component(page) {
      return __webpack_require__.e/* require */(31).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("eoZR")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    },
    meta: {
    ...
    component: function component(page) {
      return __webpack_require__.e/* require */(40).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("ZT7O")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    },
    meta: {
  ...
  // 创建开发环境
  {
    ...
    component: function component(page) {
      return Promise.all/* require */([__webpack_require__.e(0), __webpack_require__.e(43)]).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("AyF5")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    },
    meta: {
    ...
    path: 'createModelJob',
    component: function component(page) {
      return Promise.all/* require */([__webpack_require__.e(0), __webpack_require__.e(44)]).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("jzsC")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    },
    meta: {
    ...
    component: function component(page) {
      return __webpack_require__.e/* require */(6).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("UzZG")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    },
    meta: {
    ...
    component: function component(page) {
      return __webpack_require__.e/* require */(35).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("HrvH")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    },
    meta: {
      title: 'views.nav.projectDetails',
      icon: '',
    ...
    component: function component(page) {
      return __webpack_require__.e/* require */(37).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("yR4D")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    },
    meta: {
      title: 'views.nav.detailsEnvironment',
      icon: '',
    ...
    component: function component(page) {
      return __webpack_require__.e/* require */(34).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("UwLz")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    },
    meta: {
      title: 'views.nav.trainingDetails',
      icon: '',
    ...
    component: function component(page) {
      return __webpack_require__.e/* require */(36).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("lF/t")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    },
    meta: {
      title: 'views.nav.predictionDetails',
      icon: '',
    ...
    component: function component(page) {
      return Promise.all/* require */([__webpack_require__.e(0), __webpack_require__.e(38)]).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("z/gS")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    },
    meta: {
      title: 'views.nav.createTask',
      icon: '',
    ...
    component: function component(page) {
      return Promise.all/* require */([__webpack_require__.e(0), __webpack_require__.e(39)]).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("mk71")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    },
    meta: {
      title: 'views.nav.creatingModel',
      icon: '',
...
/* harmony default export */ var storageManagement = ({
  ...
  component: function component(page) {
    return __webpack_require__.e/* require */(22).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("RSF6")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
  },
  ...
  children: [{
    ...
    path: 'announcement',
    component: function component(page) {
      return Promise.all/* require */([__webpack_require__.e(0), __webpack_require__.e(10)]).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("wlFC")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    },
    meta: {
    ...
    path: 'cluster',
    component: function component(page) {
      return __webpack_require__.e/* require */(7).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("SO3l")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    },
    meta: {
    ...
    props: true,
    component: function component(page) {
      return __webpack_require__.e/* require */(23).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("9I3m")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    },
    meta: {
    ...
    props: true,
    component: function component(page) {
      return Promise.all/* require */([__webpack_require__.e(0), __webpack_require__.e(9)]).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("j3MC")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    },
    meta: {
    ...
    props: true,
    component: function component(page) {
      return Promise.all/* require */([__webpack_require__.e(0), __webpack_require__.e(21)]).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("UeOp")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    },
    meta: {
...
/* harmony default export */ var imageManagement = ({
  ...
  component: function component(page) {
    return __webpack_require__.e/* require */(49).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("WKnO")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
  },
  redirect: {
    name: 'publicImage'
  },
  ...
  children: [{
    ...
    path: 'publicImage',
    component: function component(page) {
      return Promise.all/* require */([__webpack_require__.e(0), __webpack_require__.e(45)]).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("rOlG")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    },
    meta: {
    ...
    path: 'objectImage',
    component: function component(page) {
      return Promise.all/* require */([__webpack_require__.e(0), __webpack_require__.e(47)]).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("vKWT")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    },
    meta: {
    ...
    path: 'personalImage',
    component: function component(page) {
      return Promise.all/* require */([__webpack_require__.e(0), __webpack_require__.e(46)]).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("tQcI")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    },
    meta: {
    ...
    path: 'editImage',
    component: function component(page) {
      return Promise.all/* require */([__webpack_require__.e(0), __webpack_require__.e(48)]).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("vIVt")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    },
    meta: {
...
/* harmony default export */ var caseCenter = ({
  ...
  component: function component(page) {
    return __webpack_require__.e/* require */(58).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("SyFv")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
  },
  meta: {
  ...
  children: [{
    ...
    path: '/',
    component: function component(page) {
      return __webpack_require__.e/* require */(61).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("ILRq")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    },
    meta: {
      title: 'views.nav.caseCenter',
      markName: 'caseCenter',
    ...
    path: 'caseDetail',
    component: function component(page) {
      return __webpack_require__.e/* require */(60).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("vxZN")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    },
    meta: {
    ...
    path: 'editCase',
    component: function component(page) {
      return Promise.all/* require */([__webpack_require__.e(0), __webpack_require__.e(59)]).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("68dW")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    },
    meta: {
...
/* harmony default export */ var researchForum = ({
  ...
  path: 'researchForum',
  component: function component(page) {
    return __webpack_require__.e/* require */(28).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("mRAZ")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
  },
  redirect: function redirect(to) {
    var navInformation = JSON.parse(sessionStorage.getItem('navInformation'));
    navInformation = navInformation.filter(function (item) {
  ...
  children: [{
    ...
    component: function component(page) {
      return __webpack_require__.e/* require */(29).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("V0R0")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    },
    meta: {
    ...
    path: 'forumCenter',
    component: function component(page) {
      return __webpack_require__.e/* require */(30).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("9+WO")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    },
    meta: {
    ...
    path: 'myForum',
    component: function component(page) {
      return __webpack_require__.e/* require */(27).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("u3Zw")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    },
    meta: {
    ...
    path: 'forumSend',
    component: function component(page) {
      return __webpack_require__.e/* require */(4).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("Oke+")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    },
    meta: {
    ...
    path: 'forumDetails',
    component: function component(page) {
      return __webpack_require__.e/* require */(5).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("vfs7")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    },
    meta: {
...
/* harmony default export */ var setting = ({
  ...
  path: 'setting',
  component: function component(page) {
    return __webpack_require__.e/* require */(25).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("VlR1")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
  },
  meta: {
  ...
  children: [{
    ...
    path: '/',
    component: function component(page) {
      return Promise.all/* require */([__webpack_require__.e(0), __webpack_require__.e(24)]).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("iECu")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    },
    meta: {
      markName: 'setting',
      show: false,
    ...
    path: '/',
    component: function component(page) {
      return __webpack_require__.e/* require */(26).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("kgUE")]; ((page).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    },
    meta: {
      markName: 'setting',
      show: false,
...
/* harmony default export */ var router = (new vue_router_esm["a" /* default */]({
  ...
  routes: [{
    ...
    // personalSpace,
    storageManagement, imageManagement, caseCenter,
    // keyManagement,
    researchForum,
    // help,
    setting]
...
/* harmony default export */ var lang_en = ({
  views: extends_default()({}, views_main, views_public, views_storageManagement, views_systemManagement, en_views_login, views_projectSpace, projectHome, views_userManagement, views_systemMonitoring, views_clusterMonitoring, casecenter, personalSpace, views_researchForum, help, keyManagement, views_imageManagement),
...
/* harmony default export */ var zh = ({
  // 路由
  views: extends_default()({}, zh_views_main, zh_views_public, zh_views_storageManagement, zh_views_projectSpace, zh_views_systemManagement, zh_views_login, views_projectHome, zh_views_userManagement, zh_views_systemMonitoring, zh_views_clusterMonitoring, views_casecenter, views_personalSpace, zh_views_researchForum, views_help, views_keyManagement, zh_views_imageManagement),
...
var getters = {
  ...
  themeColor: function themeColor(state) {
    ...
    state.skins.map(function (key) {
      if ("orange".includes(key.template)) {
        color = key.color;
      }
    });
    return color;
...
var projectSpace_projectSpace = {
  ...
  mutations: {
    ...
    downloadlog: function downloadlog(state, res) {
      ...
      var link = "//192.168.10.95:85" + '/v1/practiceproject/downloadlog?access-token=' + JSON.parse(localStorage.getItem('userinfo')).access_token + ' & ' + lib_default.a.stringify(res);
      linkDown(link);
    },
...
var map = {
	...
	"./orange/views/global/陪标一首页.png": "AzRq",
	"./orange/views/help/downloadData_zh.less": "sPL8",
	"./orange/views/imageManagement.less": "WWrM",
	"./orange/views/login.less": "oITM",
	"./orange/views/main.less": "++4C",
...
module.exports = __webpack_require__.p + "static/img/empty.c538743.png";
...
/* harmony export (immutable) */ __webpack_exports__["g"] = toPercent;
/* harmony export (immutable) */ __webpack_exports__["f"] = timeData;
/* harmony export (immutable) */ __webpack_exports__["e"] = sortData;
