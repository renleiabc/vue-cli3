...
/* harmony default export */ var partTraningDetails = ({
  ...
  created: function created() {
    ...
    this.logParams.practice_id = this.obj.practice_id = this.index = this.$route.query.partTaskId;
      ...
      this.$post('/practiceproject/practicelog', obj).then(function (res) {
        ...
        if (res.code === 200) {
          ...
          if (res.data.length !== 0) {
            ...
            _this2.practice_node = [{ label: '全部', value: '' }].concat(toConsumableArray_default()(res.data.practice_node));
          }
    ...
    practicenoderesource: function practicenoderesource(obj, data) {
      ...
      this.$post('/practiceproject/practicenoderesource', obj).then(function (res) {
        ...
        if (res.code === 200) {
          ...
          resourceData.show.value = Object(util["g" /* toPercent */])(resourceData.show.value);
          resourceData.cpu.value = Object(util["g" /* toPercent */])(resourceData.cpu.value);
          resourceData.memory.value = Object(util["g" /* toPercent */])(resourceData.memory.value);
          resourceData.gpu.value = Object(util["g" /* toPercent */])(resourceData.gpu.value);
