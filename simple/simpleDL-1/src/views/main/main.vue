 ...
 * @LastEditTime: 2018-08-22 13:45:05
    * @Description: 主入口
 */
/*
* @LastEditors: aFei
* @LastEditTime: 2018-08-23 11:56:01
*/
<template>
  <el-container>
    <el-header class="views-main-el-header">
      <!-- <div class="logo"><img :src="mixinGetImage('views/global/', 'login_logo.png')"
      ...
      <div style="margin-right:10px;float:right;">
        ...
        <!-- <el-dropdown class="el-menu-user-menu"
          ...
          <span class="el-dropdown-link">
            ...
            <b v-if="this.$store.getters.checkUserCharacter==='admin'">{{$t('views.userMenu.admin')}}</b>
        ...
        <div style="margin-top: -6px;">
          <span v-if="this.$store.getters.checkUserCharacter==='admin'">{{$t('views.userMenu.admin')}}</span>
          <span v-if="this.$store.getters.checkUserCharacter==='projectManager'">{{$t('views.userMenu.projectManager')}}</span>
          <span v-if="this.$store.getters.checkUserCharacter==='projectParticipant'">{{$t('views.userMenu.projectParticipant')}}</span>
        </div>
...
export default {
  ...
  methods: {
    ...
    getIndexStyle () {
      this.getFile('/static/css/element.css').then(
        ({ data }) => {
