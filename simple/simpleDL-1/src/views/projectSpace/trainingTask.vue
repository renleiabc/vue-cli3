        ...
        <div class="views-input-box">
            <div class="tab-select">
                ...
                <div v-if="false">
                    ...
                    <el-select v-model="obj.status" :placeholder="$t('views.development.pleaseChoose')">
                ...
                <div>
                    ...
                    <el-select v-model="obj.engine" :placeholder="$t('views.development.pleaseChoose')">
                ...
                <!-- 查询、重置 -->
                <div>
                    <el-button class="btn light small" @click="taskReset" v-if="false">{{$t("views.button.reset")}}</el-button>
            ...
            <el-table ref="multipleTable" v-loading="loading" :data="trainingTask" tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange" border class="tab-content">
                ...
                <el-table-column :label="$t('views.trainingTask.trainingName')" header-align="center" align="center">
                    <template slot-scope="scope">
                        <router-link :to="{name:'traningDetails',query:{id:$route.query.id,idTask:scope.row.id}}" class="views-table-link" tag='a'>{{scope.row.name}}</router-link>
                    </template>
                </el-table-column>
                <!-- 训练任务的状态 -->
