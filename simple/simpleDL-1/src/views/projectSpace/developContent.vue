    ...
    <div class="views-project-space">
        <div class="tab-select">
            ...
            <div>
                ...
                <el-select v-model="obj.status" :placeholder="$t('views.development.pleaseChoose')" clearable>
            ...
            <el-table ref="multipleTable" v-loading="loading" :data="devData" tooltip-effect="dark" style="width: 100%" border class="tab-content">
                ...
                <el-table-column :label="$t('views.development.developmentName')" header-align="center" align="center">
                    <template slot-scope="scope">
                        <router-link :to="{name:'developDetails',query:{id:$route.query.id,idChild:scope.row.id}}" class="views-table-link" tag='a'>{{scope.row.name}}</router-link>
                    </template>
                </el-table-column>
                <!-- 训练任务的状态 -->
