...
<template>
    <div class="views-personal">
                ...
                <div class="views-develop-text">
                    ...
                    <div class="views-develop-input">
                        <el-form-item :label="$t('views.development.environmentalName')" prop="name">
                            <el-input v-model="ruleForm.name" :placeholder="$t('views.development.youCan')" minlength=2 maxlength=30 clearable></el-input>
                        </el-form-item>
                    </div>
                ...
                <div class="views-develop-text">
                    <div class="views-develop-input">
                        <el-form-item :label="$t('views.development.pleasePassword')" prop="pass">
                            <el-input v-model="ruleForm.pass" :placeholder="$t('views.development.youCan')" clearable auto-complete="off"></el-input>
                        </el-form-item>
                    </div>
                </div>
                <div class="views-develop-text">
                    <div class="views-develop-input">
                        <el-form-item :label="$t('views.development.confirmPassword')" prop="checkPass">
                            <el-input v-model="ruleForm.checkPass" :placeholder="$t('views.development.youCan')" clearable auto-complete="off"></el-input>
                        </el-form-item>
                    </div>
                </div>
            </div>
        ...
        <el-dialog :title="$t('views.trainingTask.codeDirectory')" :visible.sync="dialogAddress" :before-close="handleClose" class="small">
            <div class="content">
                <views-code-file @selectStroage='showStroage($event)' :projectId="projectId"></views-code-file>
            </div>
