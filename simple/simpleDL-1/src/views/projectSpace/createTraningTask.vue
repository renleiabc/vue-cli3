...
<template>
    <div class="views-personal">
                    ...
                    <el-form-item :label="$t( 'views.trainingTask.operatParameters')"
                        ...
                        <div class="views-develop-params">
                            <div class="views-develop-caffe"
                                v-for="(item,index) in caffeParams"
                                :key="item.label">
                                <el-input v-model="item.label"
                                    disabled></el-input>
                                <b class="views-task-sign">=</b>
                                <el-input v-model="item.value"
                                    @blur="caffeBlur(index)"
                                    v-if="index === caffeParams.length-1"
                                    readonly></el-input>
                                <el-input v-model="item.value"
                                    @blur="caffeBlur(index)"
                                    v-else></el-input>
                    ...
                    <el-form-item :label="$t( 'views.trainingTask.operatParameters')"
                        ...
                        <div class="views-develop-params">
                            <div class="views-develop-caffe"
                                ...
                                <b class="views-task-sign">=</b>
                                <el-input v-model="item.value"
                                    @blur="tensorflowBlur(index)"></el-input>
                                <span class="views-task-tips"
                                    v-show="item.isShow">{{item.tip}}</span>
                            </div>
                        </div>
        ...
        <!-- 选择代码目录 -->
        <div v-for="(item,index) in ruleForm.choice"
            :key="index">
            <el-dialog :title="item.title"
                ...
                <span slot="footer"
                    ...
                    <el-button class="cancel"
                        @click="item.dialogCode = false">{{$t('views.button.cancel')}}</el-button>
...
import { validateUsername, spaceTest } from '@/util/validate.js'
export default {
  data () {
