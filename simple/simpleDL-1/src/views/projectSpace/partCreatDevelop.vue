                ...
                <div class="views-develop-text">
                    <div class="views-develop-input">
                        <el-form-item :label="$t('views.development.pleasePassword')" prop="pass">
                            <el-input type="password" v-model="ruleForm.pass" :placeholder="$t('views.development.youCan')" clearable auto-complete="off"></el-input>
                        </el-form-item>
                    </div>
                </div>
                <div class="views-develop-text">
                    <div class="views-develop-input">
                        <el-form-item :label="$t('views.development.confirmPassword')" prop="checkPass">
                            <el-input type="password" v-model="ruleForm.checkPass" :placeholder="$t('views.development.youCan')" clearable auto-complete="off"></el-input>
                        </el-form-item>
                    </div>
                </div>
            </div>
