 ...
 * @LastEditors: renlei
 * @LastEditTime: 2019-08-30 16:44:53
 * @Description:个人空间-创建模型预测
 -->
        ...
        <el-dialog :title="modelDialog.title"
            ...
            <div class="content">
                <component :is="assembly"
                    ...
                    :type='modelDialog.type' @storageUserOn="handleStorageUserOn($event)">
                </component>
            </div>
            <span slot="footer"
                class="dialog-footer">
...
export default {
  ...
  methods: {
    ...
    modelpredictioncreate (obj) {
      this.$post('/personal/modelpredictioncreate', obj).then(res => {
