 ...
 * @LastEditors: renlei
 * @LastEditTime: 2019-09-01 15:36:50
...
export default {
  data () {
    ...
    return {
      ...
      createDevrules: {
        ...
        mirror: [
          { required: false, message: '请选择镜像', trigger: 'change' }
        ],
        mounting: [
  ...
  computed: {
    imagecategorylist () { // 镜像分类
      //  console.log(JSON.stringify(this.$store.getters.postImagecategorylist))
      return this.$store.getters.postImagecategorylist
    },
    projectconfig () { // 我参与项目配额限制数据处理
