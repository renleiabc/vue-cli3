 ...
 * @LastEditors: renlei
 * @LastEditTime: 2019-08-30 17:08:28
        ...
        <el-dialog :title="modelDialog.title"
            ...
            <div class="content">
               <component :is="assembly"
                    ...
                    :projectId="projectId" @storageUserOn="handleStorageUserOn($event)">
                </component>
            </div>
            <span slot="footer"
                class="dialog-footer">
  ...
  methods: {
    ...
    dialogSure () {
      ...
      if (projectpath === '') {
        ...
        this.mount_info['keyFileName'] = `${storageUser.keyname}.keytab`
        this.mount_info['keyFile'] = storageUser.key_file
