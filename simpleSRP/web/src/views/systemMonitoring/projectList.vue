    ...
    <el-table class="tab-content"
      ...
      <el-table-column prop="cpu"
        ...
        <template slot-scope="scope">
          {{scope.row.project_cpu_use}}核/{{(scope.row.project_cpu_use/scope.row.cpu).toFixed(2)}}%
        </template>
      </el-table-column>
      <el-table-column prop="memory"
                       ...
                       label='内存'>
        <template slot-scope="scope">
          {{scope.row.project_memory_use}}G/{{(scope.row.project_memory_use/scope.row.memory).toFixed(2)}}%
        </template>
      </el-table-column>
      <el-table-column prop="gpu"
                       ...
                       label='GPU'>
        <template slot-scope="scope">
          {{scope.row.project_gpu_use}}个/{{(scope.row.project_gpu_use/scope.row.gpu).toFixed(2)}}%
        </template>
      </el-table-column>
