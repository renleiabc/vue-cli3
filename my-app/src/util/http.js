 ...
 * @LastEditors: renlei
 * @LastEditTime: 2020-06-09 16:57:38
 @Description: 主入口
*/
...
axios.defaults.baseURL = 'http://rap2.taobao.org:38080/app/mock/254896/'; // 内网
...
export function post(url, ...key) {
  ...
  return new Promise((resolve, reject) => {
    axios
      .post(url, qs.stringify(eject.data))
      .then((response) => {
        resolve(response.data);
      })
      .catch((res) => {
